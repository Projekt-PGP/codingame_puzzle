...
public class Constants {
    ...
    public static final String VERTICLE_SPRITE = "verticle_png.png";
    public static final String VERTICLE_SPRITE2 = "verticle_png2.png";
    public static final String VERTICLE_SPRITE3 = "verticle_png3.png";
    public static final String VERTICLE_SPRITE4 = "verticle_png4.png";
